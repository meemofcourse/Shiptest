...
// How much radiation is harmless to a mob
...
// Mob and non-mob budgets each gets a share from the radiation as large as this;
...
#define RAD_CONTAMINATION_BUDGET_SIZE 0.2
#define RAD_DISTANCE_COEFFICIENT 1

// Radiation components have additional penalty at distance coefficient
// This is to reduce radiation by contaminated objects, mostly
#define RAD_DISTANCE_COEFFICIENT_COMPONENT_MULTIPLIER 2

// The half-life of contaminated objects
#define RAD_HALF_LIFE 90

// Radiation waves with less than this amount of power stop spreading
// WARNING: Reducing can make rads subsytem more expensive
#define RAD_WAVE_MINIMUM 10

// To ensure slow contamination
// WARNING: Reducing can make rads subsytem more expensive
#define RAD_COMPONENT_MINIMUM 1
...
// RC-constant for the LP filter for geiger counters. See #define LPFILTER for more info.
#define RAD_GEIGER_RC 4
// How many seconds after we last detect a radiation pulse until we stop blipping
#define RAD_GEIGER_GRACE_PERIOD 4
